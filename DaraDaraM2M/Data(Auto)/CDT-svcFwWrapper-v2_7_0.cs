...
{
    [OM2MXmlRoot("svcFwWrapper","ajfw")]
    public partial class OM2MSvcFwWrapper : OM2MFlexContainerResource
    {
    ...
    [OM2MXmlRoot("svcFwWrapperAnnc","ajfwa")]
    public partial class OM2MSvcFwWrapperAnnc : OM2MAnnouncedFlexContainerResource
    {
        [OM2MXmlElement("childResource", typeof(OM2MChildResourceRef))]
        public List<OM2MChildResourceRef> ChildResource
        {
